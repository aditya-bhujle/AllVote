  ...
  return (
    <View style={styles.MakeBallotCard}>
      ...
      <View style={styles.container}>
        <TouchableOpacity onPress={onPress1} style={styles.MakeballotButton}>
          <Text style={styles.BallotbuttonText}>{buttonText1}</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={onPress2} style={styles.MakeballotButton}>
...
export function CompletedCard({
  ...
  return (
    <View style={box_style}>
      ...
      <TouchableOpacity onPress={onPress} style={styles.ballotButton}>
        <Text style={button_text_color}>{buttonText}</Text>
      </TouchableOpacity>
    </View>
  );
}
export function NewsHubCardBlack({
  buttonText_color,
  title,
  content,
  buttonText,
  ...
  return (
    <View style={styles.NewsBallotCardBlack}>
      <Text style={styles.title}>{title}</Text>
      <Text style={styles.content}>{content}</Text>
      <TouchableOpacity onPress={onPress} style={styles.button}>
        <Text style={buttonText_color}>{buttonText}</Text>
...
export function NewsHubCardGreen({
  buttonText_color,
  title,
  content,
  buttonText,
  ...
  return (
    <View style={styles.NewsBallotCardGreen}>
      <Text style={styles.title}>{title}</Text>
      <Text style={styles.content}>{content}</Text>
      <TouchableOpacity onPress={onPress} style={styles.button}>
        <Text style={buttonText_color}>{buttonText}</Text>
